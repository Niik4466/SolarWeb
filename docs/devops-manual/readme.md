...
![arquitectura](/docs/images/monolito-modular-con-servicios-de-datos-desacoplados.png)
...
1.  **Variables de Entorno:**
    ...
    *Para ver un ejemplo de las variables requeridas, consulta el archivo `docs/devops-manual/setup.md`.*
